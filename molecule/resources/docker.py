...
try:
    from molecule.resources.docker import APIError, TLSParameterError
    from molecule.resources.docker import TLSConfig
    from molecule.resources.docker import DEFAULT_TIMEOUT_SECONDS, DEFAULT_DOCKER_API_VERSION
...
try:
    from molecule.resources.docker import Client
except ImportError as exc:
    try:
        from molecule.resources.docker import APIClient as Client
    except ImportError as exc:
        HAS_DOCKER_ERROR = str(exc)
        HAS_DOCKER_PY = False
